...
acme-app is a fixture; keep changes minimal and lint-green.
...
2. Create its `SCHEMA.md` from the template, filling every placeholder —
   especially the one-line purpose.
